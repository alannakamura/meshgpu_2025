...
def main(numL, numC, test_nsga2):
    ...
    # f = open('results2.pkl', 'rb')
    # f = open('results_4_30sim_300iter_128pop_-1.0alpha_4060.pkl', 'rb')
    # f = open('results_1_30sim_400iter_128pop_-1.0alpha_4060.pkl', 'rb')
    # f = open('results_3_30sim_600iter_128pop_-1.0alpha_4060.pkl', 'rb')

    # f = open('testes/gecco/041224/results_2_100sim_30iter_128pop_-1.0alpha_4060.pkl', 'rb')
    # f = open('testes/gecco/041224/results_5_100sim_30iter_128pop_-1.0alpha_4060.pkl', 'rb')
    # f = open('testes/gecco/041224/results_6_100sim_30iter_128pop_-1.0alpha_4060.pkl', 'rb')
    # f = open('testes/gecco/041224/results_7_100sim_30iter_128pop_-1.0alpha_4060.pkl', 'rb')

    # f = open('testes/gecco/171224/results_2_100sim_30iter_128pop_1.0alpha_4060.pkl', 'rb')
    #perde para cpu por 0,0004
    # f = open('testes/gecco/171224/results_5_100sim_30iter_128pop_1.0alpha_4060.pkl', 'rb')
    #ganha da cpu
    # f = open('testes/gecco/171224/results_5_100sim_40iter_128pop_1.0alpha_4060.pkl', 'rb')
    #manteve igual ao do cpu
    # f = open('testes/gecco/171224/results_6_100sim_30iter_128pop_1.0alpha_4060.pkl', 'rb')
    # continuou ganhando da cpu
    # f = open('testes/gecco/171224/results_7_100sim_30iter_128pop_1.0alpha_4060.pkl', 'rb')

    # f = open('testes/gecco/201224/results_1_100sim_30iter_128pop_1.0alpha_4060.pkl', 'rb')
    # f = open('testes/gecco/201224/results_3_100sim_30iter_128pop_1.0alpha_4060.pkl', 'rb')
    # f = open('testes/gecco/201224/results_4_100sim_30iter_128pop_1.0alpha_4060.pkl', 'rb')

    # f = open('testes/gecco/271224/results_1_100sim_400iter_128pop_1.0alpha_4060.pkl', 'rb')
    # f = open('testes/gecco/271224/results_3_100sim_300iter_128pop_1.0alpha_4060.pkl', 'rb')
    # f = open('results_1_100sim_400iter_128pop_1.0alpha_4060.pkl', 'rb')

    # f = open('testes/gecco/130125_3var/results_1_100sim_50iter_128pop_1.0alpha_4060.pkl', 'rb')
    # f = open('testes/gecco/130125_3var/results_2_100sim_50iter_128pop_1.0alpha_4060.pkl', 'rb')
    # f = open('testes/gecco/130125_3var/results_3_100sim_50iter_128pop_1.0alpha_4060.pkl', 'rb')
    # f = open('testes/gecco/130125_3var/results_4_100sim_50iter_128pop_1.0alpha_4060.pkl', 'rb')
    # f = open('testes/gecco/130125_3var/results_5_100sim_50iter_128pop_1.0alpha_4060.pkl', 'rb')
    # f = open('testes/gecco/130125_3var/results_6_100sim_50iter_128pop_1.0alpha_4060.pkl', 'rb')
    # f = open('testes/gecco/130125_3var/results_7_100sim_50iter_128pop_1.0alpha_4060.pkl', 'rb')

    #200625
    # f = open('results_1_100sim_30iter_128pop_3posdim_1.0alpha_3060.pkl', 'rb')
    f = open('results_1_100sim_30iter_128pop_10posdim_1.0alpha_3060.pkl', 'rb')
    # f = open('results_2_100sim_30iter_128pop_3posdim_1.0alpha_3060.pkl', 'rb')
    # f = open('results_3_100sim_30iter_128pop_3posdim_1.0alpha_3060.pkl', 'rb')
    # f = open('results_4_100sim_30iter_128pop_3posdim_1.0alpha_3060.pkl', 'rb')
    # f = open('results_5_100sim_30iter_128pop_3posdim_1.0alpha_3060.pkl', 'rb')
    # f = open('results_6_100sim_30iter_128pop_3posdim_1.0alpha_3060.pkl', 'rb')
    # f = open('results_7_100sim_30iter_128pop_3posdim_1.0alpha_3060.pkl', 'rb')
